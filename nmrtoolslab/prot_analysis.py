...
class import_bmrb_2(object):
    def __init__(self,bmrb_id):
        self.bmrb_id = bmrb_id
        self.bmrb_entry = False
        self.sequence = False
        
        
        self.import_bmrb_from_file()


    def import_bmrb_from_file(self):
        self.bmrb_entry = pynmrstar.Entry.from_file(self.bmrb_id)
        
    def get_sequence(self):
        self.sequence = list(self.bmrb_entry['entity_1']['Polymer_seq_one_letter_code'][0])
        self.sequence = [s for s in self.sequence if s != '\n']
...
class pressure_fitting(object):
    ...
    def data_selection(self):
        ...
        self.pressure_pts =  selected_data.loc[:,'pressure']*0.1
    ...
    def fit(self):
        ...
        self.params = popt
        self.err_params = [pcov[0,0]**0.5,pcov[1,1]**0.5,pcov[2,2]**0.5]
    ...
    def plot(self, fit: bool = False, plot:bool = False, color:bool = False):
        ...
        if fit:
            ...
            simulated_curve = self.linear_model(self.params[0],self.params[1],self.params[2],pressure_sim)
...
class temperature_fitting(object):
    ...
    def data_selection(self):
        ...
        self.temperature_pts = [i for i in self.temperature_pts] # Data in Celsius
        self.shift =  selected_data.loc[:,'shift'].tolist()
